...
class RejectedSubTabs(private val tabbedPane: CustomTabbedPane) : JPanel() {
    ...
    init {
        ...
        val buttonPanel = JPanel().apply {
            ...
            val allRejectedButton = SelectButtonRoundedBorder(50).apply {
                createRoundedButton(
                    "거절전체",
            ...
            val customerCancelButton = SelectButtonRoundedBorder(50).apply {
                createRoundedButton(
                    "고객취소",
                    MyColor.DARK_RED,//선택 버튼 배경 색상
                    MyColor.UNSELECTED_BACKGROUND_COLOR,
            ...
            val storeRejectButton = SelectButtonRoundedBorder(50).apply {
                createRoundedButton(
                    "가게거절",
                    MyColor.DARK_RED,//선택 버튼 배경 색상
                    MyColor.UNSELECTED_BACKGROUND_COLOR,
            ...
            val storeCancelButton = SelectButtonRoundedBorder(50).apply {
                createRoundedButton(
                    "가게취소",
                    MyColor.DARK_RED,//선택 버튼 배경 색상
                    MyColor.UNSELECTED_BACKGROUND_COLOR,
