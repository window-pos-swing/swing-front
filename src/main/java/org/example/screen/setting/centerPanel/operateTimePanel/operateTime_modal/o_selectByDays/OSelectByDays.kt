package org.example.screen.setting.centerPanel.operateTimePanel.operateTime_modal.o_selectByDays
                    ...
                    val dayButton = RoundButton(day).apply {
                        ...
                        addActionListener {
                            ...
                            if (selectedDay2.contains(day.trim())) {
                                JOptionPane.showMessageDialog(this@OSelectByDays, "이미 추가된 요일입니다.")
                                setSelected(true)
            ...
            val addButton = RoundedButton("추가하기").apply {
                ...
                addActionListener {
                    ...
                    if (selectedDays.isEmpty()) {
                        JOptionPane.showMessageDialog(this@OSelectByDays, "적어도 하나의 요일을 선택해야 합니다.")
                        return@addActionListener
                    }
