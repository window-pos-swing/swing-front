        ...
        // 4. [footerPanel] 수저/포크 선택 및 요청사항 (왼쪽 정렬)
         footerPanel.apply {
            ...
            val spoonForkLabel = FillRoundedLabel(
                ...
                borderColor = if (order.disposable) MyColor.Yellow else MyColor.LIGHT_NAVY,  // 테두리 색상
                backgroundColor = if (order.disposable) MyColor.Yellow else MyColor.LIGHT_NAVY,  // 배경 색상 (노란색)
